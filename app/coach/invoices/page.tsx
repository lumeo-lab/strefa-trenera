          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ background: 'var(--bg-card)', borderBottom: '1px solid var(--border)' }}>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Nr faktury</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Zawodnik</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Opis</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Data</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Termin</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Kwota</th>
                <th className="text-left px-5 py-4 font-medium text-xs" style={{ color: 'var(--text-muted)' }}>Status</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((inv, i) => {
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-mid)', color: '#E8EAF0' }}
            >
